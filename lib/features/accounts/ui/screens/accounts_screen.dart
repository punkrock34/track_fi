      ...
      child: Scaffold(
        body: activeAsync.when(
          ...
          data: (List<Account> active) => inactiveAsync.when(
            ...
            data: (List<Account> inactive) => totalAsync.when(
              ...
              data: (double total) => CustomScrollView(
                slivers: <Widget>[
                  ...
                  // Total balance based on active accounts
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: const EdgeInsets.all(DesignTokens.spacingMd),
                  ...
                  if (inactive.isNotEmpty)
                    SliverPadding(
                      padding: const EdgeInsets.symmetric(horizontal: DesignTokens.spacingMd),
                      sliver: SliverOpacity( // <-- fix: must be a Sliver*
                        opacity: 0.7,
                        sliver: AccountsView(
                          accounts: inactive,
                          totalBalance: total, // or 0 if you don't want totals here
                          currentCurrency: currentCurrencySymbol,
                          onAccountTap: (Account a) => context.goNamed(
                            'account-details',
                            pathParameters: <String, String>{'accountId': a.id},
